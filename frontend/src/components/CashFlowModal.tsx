...
export function CashFlowModal({ onClose, userProfile, currentUser, showAlert, showConfirm }: CashFlowModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-[#0F172A]/40 backdrop-blur-xs flex items-center justify-center p-4 z-50 overflow-y-auto antialiased">
      <div className="bg-white rounded-3xl shadow-2xl border border-slate-155 max-w-5xl w-full flex flex-col my-8 outline-hidden">
        ...
        <div className="p-6 overflow-y-auto max-h-[68vh] space-y-6 flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-[#C5A021]/5 border border-[#C5A021]/20 rounded-2xl p-4 flex items-center justify-between">
              <div>
                <span className="block text-[10px] font-black uppercase text-amber-600 tracking-wider">Saldo em Caixa</span>
              ...
              <div className="p-2.5 rounded-xl bg-amber-100 text-[#C5A021]">
        ...
        <div className="p-6 border-t border-slate-100 bg-slate-50 rounded-b-3xl flex justify-between items-center">
          <span className="text-[9px] text-slate-400 font-black tracking-wider uppercase flex items-center gap-1.5">
            <Clock className="w-3.5 h-3.5 text-slate-350" /> Canal de Segurança Encriptado WA Fort Cobrança
          </span>
          <button
            type="button"
            onClick={onClose}
